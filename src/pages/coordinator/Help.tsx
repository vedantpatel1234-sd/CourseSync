...
const faqs = [
  { q: 'What can I do as a coordinator?', a: 'You have read-only access to view the dashboard, all assignments, instructor workloads, and analytics. You cannot edit or delete any data.' },
  { q: 'How do I see all current assignments?', a: 'Go to Assignments from the sidebar to see every instructor-to-section assignment currently active.' },
  { q: 'How do I check instructor workload?', a: 'Go to Instructors from the sidebar to see each instructor with their current workload bar.' },
  { q: 'Can I export analytics data?', a: 'Yes, the Analytics page includes export options for reports.' },
]
